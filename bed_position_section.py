...
def create_bed_section(content_frame):
    ...
    def load_beds():
        ...
        button1 = customtkinter.CTkButton(
            content_frame,
            text="Fowler",
            command=lambda: trigger_alert("Fowler Selected"),
            fg_color="#2E8B57",
            hover_color="#3CB371",
            text_color="white",
            height=35,
        ...
        button2 = customtkinter.CTkButton(
            content_frame,
            text="Supine",
            command=lambda: trigger_alert("Supine Selected"),
            fg_color="#2E8B57",
            hover_color="#3CB371",
            text_color="white",
            height=35,
    ...
    def trigger_alert(selection):
        """Checks a condition and triggers an alert."""
        if selection == "Fowler Selected":  # Example condition
            create_alert(content_frame, "Fowler bed condition triggered!")
        elif selection == "Supine Selected":  # Example condition
            create_alert(content_frame, "Supine bed condition triggered!")
