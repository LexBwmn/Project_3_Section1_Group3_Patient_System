...
def create_glucose_section(content_frame):
    ...
    def load_glucose():
        ...
        button1 = customtkinter.CTkButton(
            ...
            command=lambda: trigger_alert_g("Stop Selected"),
            fg_color="#2E8B57",
            hover_color="#3CB371",
            text_color="white",
            height=35,
        ...
        button2 = customtkinter.CTkButton(
            ...
            command=lambda: trigger_alert_g("Start Selected"),
            fg_color="#2E8B57",
            hover_color="#3CB371",
            text_color="white",
            height=35,
    ...
    def trigger_alert_g(selection):
        """Checks a condition and triggers an alert."""
        if selection == "Start Selected":  # Example condition
            create_alert(content_frame, "Start condition triggered!")
        elif selection == "Stop Selected":  # Example condition
